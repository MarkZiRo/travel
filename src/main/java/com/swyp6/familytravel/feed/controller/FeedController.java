...
public class FeedController {
    ...
    public FeedDetailResponse deleteFeed(@PathVariable("feedId") Long feedId, Long userId){
    ...
    public FeedPreviewResponse likeFeed(@PathVariable("feedId") Long feedId, @RequestParam Long userId){
    ...
    public FeedPreviewResponse dislikeFeed(@PathVariable("feedId") Long feedId, @RequestParam Long userId){
    ...
    public PageImpl<FeedPreviewResponse> getRecommendFeedList(@RequestParam Long userId, Pageable pageable){
    ...
    @GetMapping("/feedList")
    public List<FeedPhotoViewResponse> getUserFeedList(@RequestParam Long userId){
